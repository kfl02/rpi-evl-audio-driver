...
#define CVGATE_OUT1_PIN_NAME  "cv_gate_out1"
#define CVGATE_OUT2_PIN 27
#define CVGATE_OUT2_PIN_NAME  "cv_gate_out2"
#define CVGATE_OUT3_PIN 22
#define CVGATE_OUT3_PIN_NAME  "cv_gate_out3"
#define CVGATE_OUT4_PIN 23
#define CVGATE_OUT4_PIN_NAME  "cv_gate_out4"
#define CVGATE_IN1_PIN 24
#define CVGATE_IN1_PIN_NAME  "cv_gate_in1"
#define CVGATE_IN2_PIN 25
#define CVGATE_IN2_PIN_NAME  "cv_gate_in2"

#define CVGATE_OUTS_LIST \
	CVGATE_OUT1_PIN, CVGATE_OUT2_PIN, CVGATE_OUT3_PIN, CVGATE_OUT4_PIN
#define CVGATE_OUTS_NAMES_LIST \
	CVGATE_OUT1_PIN_NAME, CVGATE_OUT2_PIN_NAME, CVGATE_OUT3_PIN_NAME, \
	CVGATE_OUT4_PIN_NAME

#define CVGATE_INS_LIST CVGATE_IN1_PIN, CVGATE_IN2_PIN
#define CVGATE_INS_NAMES_LIST CVGATE_IN1_PIN_NAME, CVGATE_IN2_PIN_NAME
