...
#define AUDIO_GET_INPUT_CHAN_INFO \
	_IOWR(AUDIO_IOC_MAGIC, 11, struct audio_channel_info_data)
/* ioctl for getting audio channel information */
#define AUDIO_GET_OUTPUT_CHAN_INFO \
	_IOWR(AUDIO_IOC_MAGIC, 12, struct audio_channel_info_data)
...
enum usb_audio_type { NONE = 1, NATIVE_ALSA, EXTERNAL_UC };
